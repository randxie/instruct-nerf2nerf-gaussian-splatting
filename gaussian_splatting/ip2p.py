...
try:
    ...
    LOG.info("[bold red]Missing Stable Diffusion packages.")
    LOG.info(r"Install using [yellow]pip install nerfstudio\[gen][/yellow]")
    LOG.info(r"or [yellow]pip install -e .\[gen][/yellow] if installing from source.")
    sys.exit(1)
...
class InstructPix2Pix(nn.Module):
    ...
    def __init__(self,
        ...
        LOG.info("InstructPix2Pix loaded!")
    ...
    def edit_image(self,
                   ...
                   upper_bound: float = 0.98) -> torch.Tensor:
